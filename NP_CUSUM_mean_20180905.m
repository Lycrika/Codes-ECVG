...
rcal = 1000;
no = [10000];                     % Reference sample size         n = #(X) = [30 50 100 200 500 1000 3000 5000 10000];  
mo = [3 7];                       % Batch sample size to monitor  m = #(Y) = [1 3 5 7 10]
    ...
    for iu = 1:uu
        ...
        for R =1:REP  % I can't use parfor here, because I'm saving ARL(j).
            ...
            for r=1:rep  %%% Parallel toolbox 
                [RL, var, count] = CUSUM_ReferenceSample_Li(X,n,m,H,k,1,mu2,RL,var,arl);
            end % parfor(rep) ARL;
