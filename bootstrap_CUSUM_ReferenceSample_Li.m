...
function  [RL, var, count] = bootstrap_CUSUM_ReferenceSample_Li(X,n,m,H,k,s2,mu2,RL,var,ARL)
...
while (Cplus < H && Cminus < H )  && (count <= ARL*50)
    y = bootstrap_selection(X, n, m)*(s2)+mu2;
    Y = [X(1:n), y(1:m)];         
